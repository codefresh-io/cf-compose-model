...
const YamlParsingError          = require('./errorsAndWarnings/Errors/YamlParsingError');
    ...
    static parse(yaml, policy) {
        if (_.isString(yaml)) {
            try {
                ...
                return Promise.reject(new YamlParsingError(err.message, yaml));
            }
        }
