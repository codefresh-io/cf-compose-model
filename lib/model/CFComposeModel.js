...
const PromiseProvider           = require('./promise-provider/PromiseProvider');
const promiseProvider           = new PromiseProvider();
...
class CFComposeModel {
    ...
    _mapOver(field, cb) {
        ...
        return CFComposeModel.promiseProvider.resolve(p);
    }
    ...
    parseService(name, obj) {
        ...
        const p = parser.parse(this.getServicesAccessibility());
        return CFComposeModel.promiseProvider.resolve(p);
    }
    ...
    static parse(yaml, policy) {
        ...
        return CFComposeModel.promiseProvider
...
CFComposeModel.promiseProvider = promiseProvider;
