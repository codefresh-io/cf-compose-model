...
describe('Image testing', () => {
    ...
    describe('Parser', () => {
        ...
        it('Should parse only image name', () => {
            ...
            expect(image.repoName).to.be.equal('redis');
        ...
        it('Should parse image with registry and repo name', () => {
            ...
            const image       = Image.parse(imageString, 'image');
            expect(image.toString()).to.be.equal(imageString);
        });
    ...
    describe('Builder', () => {
        const Builder = Image.ImageBuilder;
        let image     = new Builder().buildOwner('me').build(); // jshint ignore:line
        it('', () => {
            // TODO : Add tests
