...
const InvalidSyntexByParser             = require('./../../errorsAndWarnings/Errors/InvalidSyntexForParser');
    ...
    getOrder() {
        ...
        if (!order.length) {
            return _.keys(_.omit(this,
                ['_name', 'warnings', '_order', '_isPortFixed', '_metadata', '_volumesType', '_portsType']));
        }
        return order;
    }
