    ...
    _actOnSpecialField(serviceInstance, fieldName, fieldValue){
        ...
        const cases = {
            ...
            'network_mode': () => {
                ...
                if (fieldValue.startsWith('service:') && (isPrivilegedModeSupported || isHybrid) ) {
                    serviceInstance.setAdditionalData(fieldName, fieldValue);
                }else{
                    serviceInstance.setAdditionalData(fieldName, this._getAdditionalData(serviceInstance, fieldName, fieldValue));
                }
            },
        };
        try {
