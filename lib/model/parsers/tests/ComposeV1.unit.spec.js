...
const InvalidSyntexByParser = require('./../../components/validations/InvalidSyntexForParser');
const FieldNotSupportedByOriginalParser = require('./../../components/validations/FieldNotSupportedByOriginalParser');
        ...
        it('Should throw an error when image passed not as string', () => {
            ...
            return CFComposeModel.load(location)
                .then(compose => {
                    ...
                    expect(image).to.be.instanceof(InvalidSyntexByParser);
                });
        });
        ...
        it('Should throw an error when ports passing not as object or array', () => {
            ...
            return CFComposeModel.load(location)
                .then((compose) => {
                    ...
                    expect(ports[0]).to.be.instanceof(InvalidSyntexByParser);
                });
        });
        ...
        it('Should throw an error when volumes passing not as object or array', () => {
            ...
            return CFComposeModel.load(location)
                .then(compose => {
                    ...
                    expect(volumes[0]).to.be.instanceof(InvalidSyntexByParser);
                });
        });
        ...
        it('Should throw an error when unsupported fields by compose passing', () => {
            ...
            return CFComposeModel.load(location)
                .then(compose => {
                    ...
                    expect(field['not_compose_field']).to.be.instanceof(FieldNotSupportedByOriginalParser);
                });
        });
    });
});