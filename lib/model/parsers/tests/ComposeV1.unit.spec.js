    ...
    describe('Should throw errors', () => {
        ...
        it('Should throw an errors and warnings together', () => {
            ...
            return parser.parse(yamlJson)
                ...
                .catch(err => {
                    expect(err).to.have.keys(['errors', 'warnings', 'originalYaml']);
                    ...
                    expect(err.warnings).to.be.deep.equal([{
                            ...
                            "_suggestion": "Volume mapping is not allowed, try use: /app",
                            "displayName": "volumes",
                            "readable": "Warning: at service os.volumes. The value ./app\n/app is not allowed. Volume mapping is not allowed, try use: /app"
                        }
                    ]);
                });
        });
