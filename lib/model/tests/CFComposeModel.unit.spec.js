            ...
            expectedWarnings: [
                {
                    ...
                    "readable": "Warning: at service dbpostgres.container_name. The key container_name is not supported. Avoid using container_name field",
                ...
                },
                {
                    ...
                    "readable": "Warning: at service dbpostgres.ports. The value 5432:5432  is not allowed. Avoid using port mapping, try use: 5432",
                    "requireManuallyFix": false,
                    "suggestion": "Avoid using port mapping, try use: 5432"
                },
                {
                    "actual": ".",
                    "autoFix": true,
                    ...
                    "readable": "Warning: at service express-app-container.build. The key . is not supported. Set image instead",
                    "requireManuallyFix": false,
                ...
                },
                {
                    ...
                    "name": "PORT_MAPPING_NOT_ALLOWED",
                    "readable": "Warning: at service express-app-container.ports. The value 3000:3000  is not allowed. Avoid using port mapping, try use: 3000",
                    "requireManuallyFix": false,
                ...
                },
                {
                    ...
                    "readable": "Warning: at service express-app-container.volumes. The value ./:/app is not allowed. Volume mapping is not allowed, try use: /app",
            ...
            const expectedWarningArray         = [
                {
                    ...
                    "name": "VOLUME_MAPPING_NOT_ALLOWED",
                    "readable": "Warning: at service redis.volumes. The value redis-data:/var/lib/redis is not allowed. Volume mapping is not allowed, try use: /var/lib/redis",
                    "requireManuallyFix": true,
                    "suggestion": "Volume mapping is not allowed, try use: /var/lib/redis"
                },
                {
                    "actual": "redis-data",
                    "autoFix": false,
                    ...
                    "readable": "Warning at: volumes.redis-data. The value redis-data is not supported. Avoid using global volumes",
                    "requireManuallyFix": false,
                ...
                },
                {
                    "actual": "mongo-data",
                    "autoFix": false,
                    "message": "Warning at: volumes.mongo-data",
                    "name": "GLOBAL_VOLUMES_NOT_SUPPORTED",
                    "readable": "Warning at: volumes.mongo-data. The value mongo-data is not supported. Avoid using global volumes",
                    "requireManuallyFix": false,
                    "suggestion": "Avoid using global volumes"
                }
            ];
    ...
    describe('getParserForYaml', () => {
        ...
        versions.map(version => {
            it(`${version.title}`, () => {
                ...
                expect(Parser).to.be.equal(version.expectedParser);
            });
        });
    });
