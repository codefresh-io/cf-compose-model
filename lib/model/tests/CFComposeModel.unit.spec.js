...
`;
                    ...
                    expect(warnings).to.be.deep.equal([
                        {
                            "_data": "value",
                            "_fieldName": "data",
                            "_message": "Volume must be object, got string",
        ...
        it('Should fix warnings when errors exist', () => {
            const yaml = {
                version: '2',
                services: {
                    web: {
    ...
    describe.skip('Upgrade compose v1 to compose v2', () => {
...
`
    ...
    describe.skip('Working with the model', () => {
        const tests = [{
    ...
    describe.skip('External volumes', () => {
